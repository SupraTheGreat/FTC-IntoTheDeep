...
@Autonomous
public class SpecimenAutoRed extends LinearOpMode {
    ...
    public void encoderDrive(double speed, double inches) {
        ...
        telemetry.addData("position:",rightFrontMotor.getCurrentPosition());
        telemetry.addData("target:",target);
        telemetry.update();
        sleep(50);
            
        while (opModeIsActive() && Math.abs(rightFrontMotor.getCurrentPosition()) < target){
            telemetry.addData("position:",rightFrontMotor.getCurrentPosition());
            telemetry.addData("target:",target);
            telemetry.update();
            //sleep(500);
