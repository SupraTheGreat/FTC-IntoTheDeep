...
public class AutonomousRed extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        //turnToHeading(TURN_SPEED, 180);               // Turn  CW to -45 Degrees
        ...
        turnToHeading(TURN_SPEED, 129);
        driveStraight(DRIVE_SPEED, 25, 129.0);
        ...
        intake.setPower(INTAKE_OFF);
        // Move backward
        driveStraight(DRIVE_SPEED, -22, 129.0);
        turnToHeading(TURN_SPEED, 175);
        driveStraight(DRIVE_SPEED, -37.5, 176);
        // Push the 1st sample
        turnToHeading(TURN_SPEED, 150);
        driveStraight(0.4, 55, 150);
        
        // Move backward
        driveStraight(DRIVE_SPEED, -22, 150.0);
        turnToHeading(TURN_SPEED, 175);
        driveStraight(DRIVE_SPEED, -27, 176);

        // Push the 2nd sample
        turnToHeading(TURN_SPEED, 160);
        driveStraight(0.4, 18, 160);
        driveStraight(0.4, 30, 165);
        //Move backward
        driveStraight(DRIVE_SPEED, -40, 165);
        turnToHeading(TURN_SPEED, 180);
        //Move sideways
        goSideways(0.5);
        //Push in the 3rd sample
        driveStraight(0.3, 50, 180); 
